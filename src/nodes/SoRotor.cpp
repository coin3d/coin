...
/*!
  ...
  The update rate of this node is dependent on the update rate of the
  \e realTime global field. The default value of this field is set so
  an update happens every 1/12th second. The low update rate is due to
  historical reasons, to be compatible with application code written
  for SGI Inventor.  One can change this value by calling
