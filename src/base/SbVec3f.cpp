...
*/
SbBool
SbVec3f::fromByteRepr(const SbByteBuffer & repr)
{
  SbBool conversionOk;
  *this = FromByteRepr<SbVec3f>(repr,&conversionOk);
  return conversionOk;
}
...
{
  SbBool conversionOk;
  *this = FromString<SbVec3f>(str,&conversionOk);
  return conversionOk;
}
...
BOOST_AUTO_TEST_CASE(byteRepr) {
  ...
  const char ToCheck [] = "32107654;:98";
