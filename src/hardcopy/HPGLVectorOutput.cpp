...
/*!
  \class SoHPGLVectorOutput HardCopy/SoHPGLVectorOutput.h
  \brief The SoHPGLVectorOutput class is used for writing in HPGL vector format.
  \ingroup hardcopy
...
SoHPGLVectorOutput::SoHPGLVectorOutput(void)
{
}
