#ifndef COIN_SBPOLARSTEREOGRAPHIC_H
#define COIN_SBPOLARSTEREOGRAPHIC_H
/**************************************************************************\
 *
...
class SbPolarStereographic : public SbGeoProjection {
...
#endif // COIN_SBPOLARSTEREOGRAPHIC_H
