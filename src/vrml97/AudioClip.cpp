...
/*!
  ...
  http://www.web3d.org/x3d/specifications/vrml/ISO_IEC_14772-All/part1/bibliography.html#[WAV]).
  It is recommended that browsers also support the MIDI file type 1
  sound format
  (see http://www.web3d.org/x3d/specifications/vrml/ISO_IEC_14772-All/part1/references.html#[MIDI]);
  MIDI files are presumed to use the
  General MIDI patch set. Subclause 4.5, VRML and the World Wide Web
  (<http://www.web3d.org/x3d/specifications/vrml/ISO_IEC_14772-All/part1/concepts.html#4.5>),
  ...
  (<http://www.web3d.org/x3d/specifications/vrml/ISO_IEC_14772-All/part1/concepts.html#4.6.9>).
