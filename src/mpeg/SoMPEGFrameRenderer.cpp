...
/*!
  \class SoMPEGFrameRenderer SoMPEGFrameRenderer.h Inventor/MPEG/SoMPEGFrameRenderer.h
  \brief The SoMPEGFrameRenderer class is for MPEG movie generation.
  \ingroup misc
...
SoMPEGFrameRenderer::SoMPEGFrameRenderer(void)
{
}
...
void
SoMPEGFrameRenderer::recordFrame(float duration)
{
  // FIXME: implement
}
