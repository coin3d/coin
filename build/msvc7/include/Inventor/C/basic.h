...
/* If singleprecision math functions are missing, define them to their
   ...
   When Coin is used together with other libraries, those libraries may
   also define some of these, so we try to avoid #define conflicts by
   wrapping each define. */
#ifndef cosf
