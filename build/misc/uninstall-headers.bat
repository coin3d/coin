...
del %COINDIR%\include\Inventor\scxml\ScXMLInitial.h
del %COINDIR%\include\Inventor\scxml\ScXMLFinal.h
del %COINDIR%\include\Inventor\scxml\ScXMLHistory.h
del %COINDIR%\include\Inventor\scxml\ScXMLTransition.h
