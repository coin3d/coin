...
del %COINDIR%\include\Inventor\MPEG\SoMPEGRenderer.h
del %COINDIR%\include\Inventor\MPEG\SoMPEGFrameRenderer.h
...
del %COINDIR%\include\Inventor\annex\HardCopy\SoCGMVectorOutput.h
del %COINDIR%\include\Inventor\annex\HardCopy\SoHPGLVectorOutput.h
del %COINDIR%\include\Inventor\annex\HardCopy\SoGDIVectorOutput.h
...
del %COINDIR%\include\Inventor\annex\HardCopy\SoVectorizeCGMAction.h
del %COINDIR%\include\Inventor\annex\HardCopy\SoVectorizeHPGLAction.h
del %COINDIR%\include\Inventor\annex\HardCopy\SoVectorizeGDIAction.h
...
del %COINDIR%\include\Inventor\events\SbPimplPtr.h
del %COINDIR%\include\Inventor\events\SbPimplPtr.hpp
del %COINDIR%\include\Inventor\events\SbLazyPimplPtr.h
del %COINDIR%\include\Inventor\events\SbLazyPimplPtr.hpp
