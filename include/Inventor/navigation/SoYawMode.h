#ifndef COIN_SOYAWMODE_H
#define COIN_SOYAWMODE_H
...
class COIN_DLL_API SoYawMode : public SoNavigationMode {
  typedef SoNavigationMode inherited;
  SO_NAVIGATION_MODE_HEADER(SoYawMode);

public:
  static void initClass(void);

  SoYawMode(SbName name);
  virtual ~SoYawMode(void);
