#ifndef COIN_SOPITCHMODE_H
#define COIN_SOPITCHMODE_H
...
class COIN_DLL_API SoPitchMode : public SoNavigationMode {
  typedef SoNavigationMode inherited;
  SO_NAVIGATION_MODE_HEADER(SoPitchMode);

public:
  static void initClass(void);

  SoPitchMode(SbName name);
  virtual ~SoPitchMode(void);
