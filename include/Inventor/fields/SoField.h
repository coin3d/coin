...
// The rest is field subclasses. Fields _not_ disabled are: SoField,
// SoSField, SoSFInt32 (simple testfield), SoSFBool (simple
// testfield), SoSFString (used by testnode class SoInfo).
