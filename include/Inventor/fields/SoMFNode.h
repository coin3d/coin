// FIXME: SoMFNode is missing a handful of API methods versus SGI
// Inventor. Add them. (So, scrap the common template mechanism?)
// 20011024 mortene.
...
//$ BEGIN TEMPLATE MFNodeAndEngine(NODE, Node)
