#!/bin/sh
# Regression test for the SoSelection protected-SoCallbackList*-field
# compatibility fix (P1 code review) -- see repro.cpp for the full
# explanation.
#
#   testsuite/reproducers/soselection-protected-callbacklist-abi/run.sh /path/to/build/lib
#
