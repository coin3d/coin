#!/bin/sh
# Correctness check for the new SoPath::getFullXxx() methods (Phase 1 of
# the SoPath/SoFullPath downcast UB fix) -- see repro.cpp for the full
# explanation.
#
#   testsuite/reproducers/sopath-getfull-methods/run.sh /path/to/build/lib
#
