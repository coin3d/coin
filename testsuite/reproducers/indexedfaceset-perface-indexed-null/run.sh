...
# when materialBinding is PER_FACE_INDEXED (or PER_PART_INDEXED) but
# materialIndex is left empty on the shape. See repro.cpp for the full
# explanation.
#
#   testsuite/reproducers/indexedfaceset-perface-indexed-null/run.sh /path/to/build/lib
#
# Before the fix: SIGSEGV inside SoIndexedFaceSet::generatePrimitives().
